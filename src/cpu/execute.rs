    ...
    pub fn execute(&mut self, opcode: u8, mem: &mut memory::Memory) -> Instruction {
        match opcode {
            ...
            0x18 => {
                ...
                Instruction::Ok(opcode,2, 3, "JR r8")
            }
            0x19 => {
            ...
            0x20 => {
                if !self.get_flag(Flag::C) {
                    self.PC = self.PC.wrapping_add(self.get_n(mem) as u16);
                    return Instruction::Ok(opcode,2, 3, "JR NC,r8");
                }
            ...
            0x28 => {
                if self.get_flag(Flag::Z) {
                    self.PC = self.PC.wrapping_add(self.get_n(mem) as u16);
                    return Instruction::Ok(opcode,2, 3, "JR Z,r8");
                }
            ...
            0x30 => {
                if !self.get_flag(Flag::C) {
                    self.PC = self.PC.wrapping_add(self.get_n(mem) as u16);
                    return Instruction::Ok(opcode,2, 12, "JR NC,r8");
                }
            ...
            0x38 => {
                if self.get_flag(Flag::C) {
                    self.PC = self.PC.wrapping_add(self.get_n(mem) as u16);
                    return Instruction::Ok(opcode,2, 12, "JR C,r8");
                }
            ...
            0xc2 => {
                if !self.get_flag(Flag::Z) {
                    ...
                    return Instruction::Ok(opcode,3, 16, "JP NZ, a16");
                }
                Instruction::Ok(opcode,3, 12, "JP NZ, a16")
            }
            0xc3 => {
                self.PC = self.PC.wrapping_add(self.get_nn(mem));
                Instruction::Ok(opcode,3, 16, "JP a16")
            }
            0xc4 => {
                if !self.get_flag(Flag::Z) {
                    self.call(mem);
            ...
            0xca => {
                if self.get_flag(Flag::Z) {
                    self.PC = self.PC.wrapping_add(self.get_nn(mem));
                    return Instruction::Ok(opcode,3, 16, "JP Z, a16");
                }
            ...
            0xd2 =>  {
                if !self.get_flag(Flag::C) {
                    self.PC = self.PC.wrapping_add(self.get_nn(mem));
                    return Instruction::Ok(opcode,3, 16, "JP NC, a16");
                }
            ...
            0xda => {
                if self.get_flag(Flag::C) {
                    self.PC = self.PC.wrapping_add(self.get_nn(mem));
                    return Instruction::Ok(opcode,3, 16, "JP C, a16");
                }
